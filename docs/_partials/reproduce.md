...
```bash
git clone --recurse-submodules https://github.com/GeoffChurch/REU_Slum_Optimization.git
...
[its README](https://github.com/GeoffChurch/REU_Slum_Optimization/tree/main/examples/screen-bakeoff).
