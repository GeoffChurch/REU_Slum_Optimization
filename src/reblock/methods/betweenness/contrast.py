...
PriorDeviance -- the signed root Poisson deviance of the observed total against the no-buildings
                 ...
                 out. Ranks worse as a picture. As a generator, at the shipped settings, it ties
                 RawShare on 220 small blocks (Lens A +0.047 over clearance against +0.040) and
                 in Nairobi, leads it on a fresh Cape Town sample, and trails it on 36 large
                 blocks (Lens A 0.841 against RawShare's 0.856; on the frontier in 1 block against
                 6). Why it helps where it does -- spreading the network to the detours the
                 buildings force -- is untested."""
