...
(Home -- docs/_intro.md folded in, plus a hero figure), docs/methods/index.md (methods overview)
and docs/methods/<slug>.md (one page per method), and docs/benchmark.md (Results). The handwritten
prose pages -- docs/background.md, docs/methodology.md, docs/team.md -- are committed and this
script never creates, reads, or overwrites them; docs/_intro.md is the one committed partial it
reads (excluded from the built site) and folds into the generated Home page.
