...
| [multiblock](multiblock/) | reblock a whole informal settlement (depth 24 → 3), compare the **scalable** methods under two budgets — a fixed access-depth and a matched road budget — with per-method timing, and show why the substrate makes settlement-scale reblocking tractable. |
